...
//class 이름이 DisplayImage인 친구의 함수이름도 DisplayImage 함수 정의
{

	disp_image = cv::Mat::zeros(imsize, CV_8UC3); 
	//CV_8UC3은 하나의 픽셀이 unsigned 8bit*3(R,G,B)로 표현되는 데이터
...
//DispalyImage class의 함수 Overlay_Img 정의
{

	int pos_x, pos_y, img_width, img_height; //변수들 정수
	pos_x = ofset.width;
	pos_y = ofset.height;
